function [] = storeIndividualRuns( round5RunGuide ) 
% load tire data stored as individual sweeps and save data from each
% different nominal pressure in separate file
